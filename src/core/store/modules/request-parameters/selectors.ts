...
import { TSelectRequestType } from 'src/core/models/request-parameters';
import { State } from './index'

const state = (state: RootState) => state.requestParameters;

export const getListRequestParameters = createSelector(
	[state],
	({ list }: State) => list
);
