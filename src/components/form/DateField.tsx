...
const DatePicker = ({
	...
	useEffect(() => {
		const value = initialValues[name] ? moment(initialValues[name]).format(
			monthYear ? F.monthYear : onlyYear ? F.year : provisionReport ? F.provisionReport : F.default
		) : null
		setFieldValue(name, value)
	}, [initialValues, setFieldValue, name, onlyYear, monthYear, provisionReport])
