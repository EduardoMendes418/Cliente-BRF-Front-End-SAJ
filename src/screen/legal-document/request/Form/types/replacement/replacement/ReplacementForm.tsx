...
const ReplacementForm = (props: ReplacementFormProps) => {
	...
	const formik = useFormik<LegalDocumentPrepositionReplacementParties>({
		initialValues: {
			...
			addressPostalCode: "",
			addressStateId: 0,
			partyType: LegalDocumentPrepositionReplacementPartyEnum.Replacements
		},
			...
			<Form noValidate>
				<Box padding={3}>
					<Grid container spacing={3}>
						...
						<Grid item md={3} xs={12}>
							<TextField
								label={t("legalDocs:correspondents.number")}
								name="addressNumber"
								required
							/>
						</Grid>
						<Grid item md={3} xs={12}>
							<TextField
								label={t("legalDocs:correspondents.district")}
						...
						<Grid item md={3} xs={12}>
							<SelectField
								label={t("legalDocs:correspondents.city")}
								name="addressCityId"
						...
						<Grid item md={3} xs={12}>
							<MaskField
								label={t("legalDocs:correspondents.cep")}
