...
import { TSearchEvent } from 'src/core/models/e-social-tables';
...
const Search = () => {
	...
	return (
		<Panel title={t('eSocial:eSocialEvent.searchTitle')} withPadding>
			<Formik
