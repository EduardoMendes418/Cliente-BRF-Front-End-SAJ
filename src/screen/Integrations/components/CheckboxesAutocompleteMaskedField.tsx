...
type Props = {
	...
	maskFunction?: (old: string) => string;
};
	...
	return (
		<FormControl error={showError}>
			<Autocomplete
				...
				renderInput={({ inputProps: {value, ...inputProps}, ...params }: AutocompleteRenderInputParams & {inputProps: { value?: string }}) => (
					<TextField
						{...params}
						inputProps={{
							value: (value ? (maskFunction?.(value) ?? value) : ""),
							maxlength,
							...inputProps
						}}
						label={label}
